...
export default function FloatingContact() {
  ...
  return (
    <div ref={widgetRef} className="fixed bottom-6 left-6 z-50 flex flex-col items-center gap-4">
      {/* Sub-buttons Container */}
      <div 
        className={`flex flex-col items-center gap-4 transition-all duration-300 ease-out origin-bottom ${
      ...
      <button
        ...
        className="w-[56px] h-[56px] bg-white text-[#2E79C7] rounded-full shadow-[0_4px_14px_0_rgba(0,0,0,0.15)] flex items-center justify-center hover:scale-105 transition-all duration-300 relative z-10"
