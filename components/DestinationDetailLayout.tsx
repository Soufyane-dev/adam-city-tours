    ...
    <main className="min-h-screen bg-[#FDFBF7] text-[#0D1B2A] dark:bg-[#08080f] dark:text-[#F5F0E8]">
      ...
      <section className="relative min-h-[92vh] w-full overflow-hidden">
        <Image
          ...
          sizes="100vw"
        />
        {/* Subtle center vignette for title legibility — photo stays clear */}
        <div
          className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(8,8,15,0.45)_0%,rgba(8,8,15,0.25)_40%,rgba(8,8,15,0.15)_65%,transparent_100%)] dark:bg-[radial-gradient(ellipse_at_center,rgba(5,5,8,0.55)_0%,rgba(5,5,8,0.3)_40%,rgba(5,5,8,0.15)_65%,transparent_100%)]"
          aria-hidden
        />

        <div className="relative z-10 mx-auto flex min-h-[92vh] max-w-5xl flex-col justify-center px-6 py-32 text-center lg:px-12">
          <h1 className="title-with-gold-glow title-with-gold-glow--on-dark title-with-gold-glow--wide font-[var(--font-playfair)] text-[2.75rem] font-semibold leading-[1.05] tracking-tight text-white sm:text-6xl md:text-7xl lg:text-[5.25rem]">
            {dest.name}
          </h1>
        </div>
      </section>
      ...
      <div className="sticky top-0 z-30 border-b border-slate-200/80 bg-[#FDFBF7]/90 backdrop-blur-md dark:border-white/10 dark:bg-[#08080f]/90">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 sm:flex-row sm:items-center sm:justify-between lg:px-12">
          <nav className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-slate-500 dark:text-slate-400">
            <Link href="/" className="transition hover:text-[#2E79C7] dark:hover:text-[#C9A84C]">
              Home
            </Link>
            ...
            <div className="rounded-[2rem] border border-slate-200/80 bg-white p-8 shadow-[0_24px_80px_-24px_rgba(15,23,42,0.12)] dark:border-white/10 dark:bg-[#101018] dark:shadow-black/40 md:p-10">
              ...
              <div className="mt-8 rounded-2xl border border-[#C9A84C]/25 bg-gradient-to-br from-[#C9A84C]/[0.08] to-transparent p-6 dark:from-[#C9A84C]/10">
                <p className="text-sm leading-relaxed text-slate-700 dark:text-slate-300">
                  <span className="font-semibold text-slate-900 dark:text-white">Mortours</span>{" "}
      ...
      <section className="border-t border-slate-200/80 bg-white py-20 dark:border-white/10 dark:bg-[#0a0a12] lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div className="mb-6 flex">
            <Link
              href="/"
              className="text-xs font-bold uppercase tracking-[0.2em] text-[#2E79C7] transition hover:text-[#C9A84C] dark:text-[#C9A84C] dark:hover:text-white"
            >
              ← Back to home
            </Link>
          </div>
